...
public class RegistrarAsistenteComandoHandlerTests
{
    ...
    private readonly Mock<ILogger<RegistrarAsistenteComandoHandler>> _logger;
    ...
    public RegistrarAsistenteComandoHandlerTests()
    {
        ...
        _logger = new Mock<ILogger<RegistrarAsistenteComandoHandler>>();
        _handler = new RegistrarAsistenteComandoHandler(_repo.Object, _publishEndpoint.Object, _logger.Object);
    ...
    public async Task Handle_Valido_RegistraAsistente()
    {
        ...
        _repo.Setup(r => r.ObtenerPorIdAsync(id, It.IsAny<bool>(), It.IsAny<CancellationToken>())).ReturnsAsync(_eventoPublicado);
    ...
    public async Task Handle_EventoNoExiste_Falla()
    {
        // Arrange
        var id = Guid.NewGuid();
        _repo.Setup(r => r.ObtenerPorIdAsync(id, It.IsAny<bool>(), It.IsAny<CancellationToken>())).ReturnsAsync((Evento?)null);
    ...
    public async Task Handle_NoPublicado_Falla()
    {
        ...
        _repo.Setup(r => r.ObtenerPorIdAsync(id, It.IsAny<bool>(), It.IsAny<CancellationToken>())).ReturnsAsync(_eventoNoPublicado);
    ...
    public async Task Handle_Duplicado_Falla()
    {
        ...
        _repo.Setup(r => r.ObtenerPorIdAsync(id, It.IsAny<bool>(), It.IsAny<CancellationToken>())).ReturnsAsync(_eventoPublicadoConAsistente);
