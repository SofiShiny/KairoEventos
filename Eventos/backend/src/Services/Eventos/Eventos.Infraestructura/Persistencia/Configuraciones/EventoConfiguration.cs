...
public class EventoConfiguration : IEntityTypeConfiguration<Evento>
{
    public void Configure(EntityTypeBuilder<Evento> builder)
    {
        ...
        // Configurar la relación usando el campo privado _asistentes
        // Esto permite a EF trackear cambios en la colección privada
        builder.HasMany(e => e.Asistentes)
            .WithOne()
            .HasForeignKey(a => a.EventoId)
            .OnDelete(DeleteBehavior.Cascade);
        
        // Indicar a EF que use el campo privado _asistentes para la navegación
